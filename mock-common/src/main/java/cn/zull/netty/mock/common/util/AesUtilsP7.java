...
public class AesUtilsP7 {
    ...
    public static String encrypt(String content, String keyBytes, String iv) {
        byte[] bytes = encryptOfDiyIV(StringUtils.getBytesUtf8(content), StringUtils.getBytesUtf8(keyBytes), StringUtils.getBytesUtf8(iv));
        return Base64Utils.encryptToString(bytes);
    }
...
//            System.out.println("IV：" + new String(ivs));
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        System.out.println(AesUtilsP7.encrypt(currentTime.toString(), "a0d9c59e2a6d4127a8c1da97da8ed24f".substring(0, 16), "8f7595b8472adef1"));
        ...
        System.out.println(AesUtilsP7.decrypt("HiXgeeth2/7WWI9q25+2AQ==", "909c8be7da3d4f83", "8f7595b8472adef1"));
...
//        System.out.println("16位md5密钥：" + md5Hex16(key));
        ...
        // 解密
        String decryptResult = decrypt(encryptResult, key, StringUtils.getBytesUtf8(IV_PARAMETER));
